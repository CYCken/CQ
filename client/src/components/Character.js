...
const Character = (props) => {
  ...
  const [weaponSugs, setWeaponSug] = useState(heroProps.weapon_suggest);
  const [weaponOwns, setWeaponOwn] = useState(heroProps.weapon_own);
                ...
                <TableBody>
                  <TableRow>
                    <TableCell style={{ backgroundColor: "#a8a8a8" }}>
                      <WeaponSug hero={hero} setHero={setHero} weapons={weaponSugs} setWeapon={setWeaponSug} />
                    </TableCell>
                    <TableCell
                      style={{
                        width: "1%",
                    ...
                    />
                    <TableCell style={{ backgroundColor: "#a8a8a8" }}>
                      <WeaponOwn hero={hero} setHero={setHero} weapons={weaponOwns} setWeapon={setWeaponOwn} />
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
